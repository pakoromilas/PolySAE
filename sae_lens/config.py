...
class LoggingConfig:
    ...
    skip_wandb_finish: bool = False  # If True, don't call wandb.finish() after training (for continuing with evals)
...
class LanguageModelSAERunnerConfig(Generic[T_TRAINING_SAE_CONFIG]):
    ...
    # Expensive evals that require full model forward pass (logits)
    eval_compute_ce_loss: bool = False
    eval_compute_kl: bool = False
