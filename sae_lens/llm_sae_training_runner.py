...
class LLMSaeEvaluator(Generic[T_TRAINING_SAE]):
    ...
    n_eval_batches: int
    n_eval_batches: int
    eval_compute_ce_loss: bool
    eval_compute_kl: bool
    ...
    def __call__(
        ...
        eval_config = EvalConfig(
            ...
            compute_ce_loss=self.eval_compute_ce_loss,
            compute_kl=self.eval_compute_kl,
...
class LanguageModelSAETrainingRunner:
    ...
    def run(self):
        ...
        evaluator = LLMSaeEvaluator(
            ...
            eval_compute_ce_loss=self.cfg.eval_compute_ce_loss,
            eval_compute_kl=self.cfg.eval_compute_kl,
        ...
        if self.cfg.logger.log_to_wandb and not self.cfg.logger.skip_wandb_finish:
            wandb.finish()
